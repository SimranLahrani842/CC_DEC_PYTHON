...
if __name__ == '__main__':
	...
	img = PhotoImage(file="C:\\Simran Lahrani\\music.gif")
	next_ = PhotoImage(file = 'C:\\Simran Lahrani\\next.gif')
	prev = PhotoImage(file='C:\\Simran Lahrani\\previous.gif')
	play = PhotoImage(file='C:\\Simran Lahrani\\play.gif')
	pause = PhotoImage(file='C:\\Simran Lahrani\\pause.gif')
